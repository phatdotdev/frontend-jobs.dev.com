...
export const MESSAGE_URL = "/api/v1/messages";
export const POST_URL = "/api/v1/postings";
// RESUME
export const EDU_URL = "/api/v1/educations";
export const EXP_URL = "/api/v1/experiences";
export const SKILL_URL = "/api/v1/skills";
export const CER_URL = "/api/v1/certifications";
